...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] secondWords = ["Parrot", "Cat", "Porcupine", "Eagle", "Razor", "Hamster", "Dog", "Bird", "Bread", "Cucumber"];

    string[] thirdWords = ["Programmer", "Artist", "Punk", "Rapper", "Driver", "Kidnapper", "Thief", "Fisherman", "Banker", "Whore"];

    constructor() ERC721 ("ThreeWordNFT", "SQUARE") {
        console.log("I'm a Bird Motherfucker, I'm a Bird!");
    }
        ...
        bytes(
            string(
                abi.encodePacked(
                    ...
                    combinedWord,
                    '", "description": "Collection of stupid words!", "image": "data:image/svg+xml;base64,',
